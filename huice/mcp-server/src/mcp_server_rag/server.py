...
# RAG 连接器
# ============================================================================
# pylint: disable  MC80OmFIVnBZMlhsa0xUb3Y2bzZZVGxyVnc9PTplNmU2MTQ1Nw==
...
# noqa  MS80OmFIVnBZMlhsa0xUb3Y2bzZZVGxyVnc9PTplNmU2MTQ1Nw==
    ...
    async def rerank_results(
        ...
        for result in results:
            ...
            if pk is not None:
                ...
                deduped.append(result)
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZZVGxyVnc9PTplNmU2MTQ1Nw==
...
# type: ignore  My80OmFIVnBZMlhsa0xUb3Y2bzZZVGxyVnc9PTplNmU2MTQ1Nw==
...
def parse_arguments():
    ...
    parser.add_argument(
        "--llm-api-key", type=str, default="", help="LLM API 密钥"
    )
    parser.add_argument(
