...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZSVzFNTVE9PTo1MTE3MTBjOQ==
...
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZSVzFNTVE9PTo1MTE3MTBjOQ==
    ...
    def __init__(
        ...
        embedding_base_url: str = "http://121.40.159.60:11434",
        milvus_uri: str = "http://121.40.159.60:19530",
...
- 生成 {num_variants} 个查询变体"""
    ...
    async def rerank_results(
        ...
        seen_sources = set()
        remaining = []
# pragma: no cover  Mi80OmFIVnBZMlhsa0xUb3Y2bzZSVzFNTVE9PTo1MTE3MTBjOQ==
    ...
    async def synthesize_answer(
        ...
        for i, result in enumerate(results[:top_n], 1):
            ...
            score = result.score
# type: ignore  My80OmFIVnBZMlhsa0xUb3Y2bzZSVzFNTVE9PTo1MTE3MTBjOQ==
...
def parse_arguments():
    ...
    parser.add_argument(
        "--llm-api-key", type=str, default="sk-d631bd0f6956421a98b880b77090471e", help="LLM API 密钥"
    )
    parser.add_argument(
        "--llm-base-url", type=str, default="https://api.deepseek.com/v1", help="LLM BASE URL"
    )
    parser.add_argument(
        "--embedding-model", type=str, default="qwen3-embedding:0.6b", help="嵌入模型"
    )
    parser.add_argument(
        "--embedding-url", type=str, default="http://121.40.159.60:11434", help="嵌入服务 URL"
    )
    parser.add_argument(
