                ...
                {memory.state === "paused" || memory.state === "archived" ? (
                  <TooltipProvider>
                    <Tooltip delayDuration={0}>
                      ...
                      <TooltipContent>
                        <p>
                          {t('memories.thisMemoryIs')}{" "}
                          <span className="font-bold">
                            {memory.state === "paused" ? t('memories.paused') : t('memories.archived')}
                          </span>{" "}
                          {t('memories.and')} <span className="font-bold">{t('memories.disabled')}</span>。
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
