...
const allTabs = [{ key: "mcp", label: t('dashboard.mcpLink'), icon: "🔗" }, ...clientTabs];
...
export const Install = () => {
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold mb-6">{t('dashboard.installTitle')}</h2>
        ...
        <TabsContent value="mcp" className="mt-6">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader className="py-4">
              <CardTitle className="text-white text-xl">{t('dashboard.mcpLink')}</CardTitle>
            </CardHeader>
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              <CardHeader className="py-4">
                <CardTitle className="text-white text-xl">
                  {key.charAt(0).toUpperCase() + key.slice(1)} {t('dashboard.installationCommand')}
                </CardTitle>
              </CardHeader>
              <hr className="border-zinc-800" />
              <CardContent className="py-4">
