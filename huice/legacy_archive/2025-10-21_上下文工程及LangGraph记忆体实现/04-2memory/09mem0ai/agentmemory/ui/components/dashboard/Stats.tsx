  ...
  return (
    <div className="bg-zinc-900 rounded-lg border border-zinc-800">
      <div className="bg-zinc-800 border-b border-zinc-800 rounded-t-lg p-4">
        <div className="text-white text-xl font-semibold">{t('dashboard.memoriesStats')}</div>
      </div>
      <div className="space-y-3 p-4">
        <div>
          <p className="text-zinc-400">{t('dashboard.totalMemories')}</p>
          <h3 className="text-lg font-bold text-white">
            {totalMemories} {t('dashboard.memories')}
          </h3>
        </div>
        <div>
          <p className="text-zinc-400">{t('dashboard.totalAppsConnected')}</p>
          <div className="flex flex-col items-start gap-1 mt-2">
            ...
            <h3 className="text-lg font-bold text-white">{totalApps} {t('dashboard.apps')}</h3>
          </div>
        </div>
      </div>
    </div>
