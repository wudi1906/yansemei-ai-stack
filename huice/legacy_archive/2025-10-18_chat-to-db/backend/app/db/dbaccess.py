...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZSbTFaUkE9PTpjNGJlMmIyOQ==
    ...
    def connect_to_snowflake(
        ...
        **kwargs
        ...
        def run_sql_snowflake(sql: str) -> pd.DataFrame:
            ...
            cur = cs.execute(sql)
# type: ignore  MS80OmFIVnBZMlhsa0xUb3Y2bzZSbTFaUkE9PTpjNGJlMmIyOQ==
...
# pylint: disable  Mi80OmFIVnBZMlhsa0xUb3Y2bzZSbTFaUkE9PTpjNGJlMmIyOQ==
    ...
    def connect_to_mysql(
        ...
        **kwargs
        ...
        if not user:
            user = os.getenv("USER")
# noqa  My80OmFIVnBZMlhsa0xUb3Y2bzZSbTFaUkE9PTpjNGJlMmIyOQ==
