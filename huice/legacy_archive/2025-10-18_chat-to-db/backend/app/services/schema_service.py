...
# noqa  MC80OmFIVnBZMlhsa0xUb3Y2bzZPVVpPV2c9PTpjNWVkMGM0Mg==
...
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZPVVpPV2c9PTpjNWVkMGM0Mg==
...
def discover_postgresql_schema(inspector) -> List[Dict[str, Any]]:
    ...
    for table_name in tables:
        ...
        try:
            ...
            print(f"Warning: Could not process columns for {table_name}: {str(column_error)}")
            continue
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZPVVpPV2c9PTpjNWVkMGM0Mg==
...
def discover_sqlite_schema(inspector) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        print(f"Warning: Could not get views: {str(view_error)}")
        views = []
# noqa  My80OmFIVnBZMlhsa0xUb3Y2bzZPVVpPV2c9PTpjNWVkMGM0Mg==
