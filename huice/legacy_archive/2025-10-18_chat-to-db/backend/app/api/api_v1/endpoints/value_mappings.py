...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZka1JIY0E9PTowNzQzNTE3Zg==
...
# fmt: off  MS80OmFIVnBZMlhsa0xUb3Y2bzZka1JIY0E9PTowNzQzNTE3Zg==
...
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZka1JIY0E9PTowNzQzNTE3Zg==
...
def update_value_mapping(
    *,
    ...
    if mapping_in.nl_term and mapping_in.nl_term != mapping.nl_term:
        ...
        if existing:
            raise HTTPException(status_code=400, detail="Mapping already exists for this term")
# pragma: no cover  My80OmFIVnBZMlhsa0xUb3Y2bzZka1JIY0E9PTowNzQzNTE3Zg==
