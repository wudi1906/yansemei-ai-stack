...
WORKING_DIR = "./dickens"
# pragma: no cover  MC80OmFIVnBZMlhsa0xUb3Y2bzZORGhFZVE9PToxMzA0ZGQ3ZQ==

if not os.path.exists(WORKING_DIR):
    os.mkdir(WORKING_DIR)

# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZORGhFZVE9PToxMzA0ZGQ3ZQ==
...
def main():
    ...
    with open("./book.txt", "r", encoding="utf-8") as f:
        rag.insert(f.read())
# pylint: disable  Mi80OmFIVnBZMlhsa0xUb3Y2bzZORGhFZVE9PToxMzA0ZGQ3ZQ==
...
# type: ignore  My80OmFIVnBZMlhsa0xUb3Y2bzZORGhFZVE9PToxMzA0ZGQ3ZQ==
