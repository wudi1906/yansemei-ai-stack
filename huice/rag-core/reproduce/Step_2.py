...
# fmt: off  MC80OmFIVnBZMlhsa0xUb3Y2bzZWVEJrT1E9PTo5Yzk2MDIyYQ==

    response = openai_client.chat.completions.create(
        model=model, messages=messages, **kwargs
    )
    return response.choices[0].message.content
# type: ignore  MS80OmFIVnBZMlhsa0xUb3Y2bzZWVEJrT1E9PTo5Yzk2MDIyYQ==
...
# pylint: disable  Mi80OmFIVnBZMlhsa0xUb3Y2bzZWVEJrT1E9PTo5Yzk2MDIyYQ==
...
# pragma: no cover  My80OmFIVnBZMlhsa0xUb3Y2bzZWVEJrT1E9PTo5Yzk2MDIyYQ==
