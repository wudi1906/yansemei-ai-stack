...
# fmt: off  MC80OmFIVnBZMlhsa0xUb3Y2bzZNazg1TlE9PTpiYmUyNGQ5MQ==
...
# type: ignore  MS80OmFIVnBZMlhsa0xUb3Y2bzZNazg1TlE9PTpiYmUyNGQ5MQ==
...
class OllamaAPI:
    def __init__(self, rag: LightRAG, top_k: int = 60, api_key: Optional[str] = None):
        ...
        self.setup_routes()
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZNazg1TlE9PTpiYmUyNGQ5MQ==
                            ...
                            try:
                                async for chunk in response:
                                    if chunk:
                                        ...
                                        last_chunk_time = time.time_ns()
# noqa  My80OmFIVnBZMlhsa0xUb3Y2bzZNazg1TlE9PTpiYmUyNGQ5MQ==
