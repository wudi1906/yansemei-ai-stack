...
# pragma: no cover  MC80OmFIVnBZMlhsa0xUb3Y2bzZOM2RQYWc9PTpiZWFhMGI4Ng==
        ...
        async with self._storage_lock:
            ...
            for id in ids:
                ...
                if data:
                    ...
                    results.append(None)
            return results
# type: ignore  MS80OmFIVnBZMlhsa0xUb3Y2bzZOM2RQYWc9PTpiZWFhMGI4Ng==
        ...
        async with self._storage_lock:
            ...
            for k, v in data.items():
                ...
                if k in self._data:  # Key exists, only update update_time
                    ...
                    v["update_time"] = current_time
# pylint: disable  Mi80OmFIVnBZMlhsa0xUb3Y2bzZOM2RQYWc9PTpiZWFhMGI4Ng==
...
# type: ignore  My80OmFIVnBZMlhsa0xUb3Y2bzZOM2RQYWc9PTpiZWFhMGI4Ng==
