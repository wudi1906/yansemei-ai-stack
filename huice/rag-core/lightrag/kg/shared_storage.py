...
def direct_log(message, enable_output: bool = True, level: str = "DEBUG"):
    ...
    if not enable_output:
        return
# pragma: no cover  MC80OmFIVnBZMlhsa0xUb3Y2bzZOM2hhVlE9PTpmMTkyNDgzNQ==
...
# pylint: disable  MS80OmFIVnBZMlhsa0xUb3Y2bzZOM2hhVlE9PTpmMTkyNDgzNQ==
...
# fmt: off  Mi80OmFIVnBZMlhsa0xUb3Y2bzZOM2hhVlE9PTpmMTkyNDgzNQ==
...
def _perform_lock_cleanup(
    ...
    if threshold_check and len(cleanup_data) < CLEANUP_THRESHOLD:
        return 0, earliest_cleanup_time, last_cleanup_time
# type: ignore  My80OmFIVnBZMlhsa0xUb3Y2bzZOM2hhVlE9PTpmMTkyNDgzNQ==
