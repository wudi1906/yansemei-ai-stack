...
# pragma: no cover  MC80OmFIVnBZMlhsa0xUb3Y2bzZiek54VXc9PTpiZjdiZmY0Yw==
    ...
    async def initialize(self):
        ...
        async with get_data_init_lock():
            ...
            try:
                ...
                await self.close()
                raise
# type: ignore  MS80OmFIVnBZMlhsa0xUb3Y2bzZiek54VXc9PTpiZjdiZmY0Yw==
    ...
    async def get_by_ids(self, ids: list[str]) -> list[dict[str, Any]]:
        async with self._get_redis_connection() as redis:
            try:
                ...
                return [None] * len(ids)
# pragma: no cover  Mi80OmFIVnBZMlhsa0xUb3Y2bzZiek54VXc9PTpiZjdiZmY0Yw==
...
# fmt: off  My80OmFIVnBZMlhsa0xUb3Y2bzZiek54VXc9PTpiZjdiZmY0Yw==
