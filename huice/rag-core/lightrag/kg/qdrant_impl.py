...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZVMGR4WWc9PTpjNzM0MjBhYw==
    ...
    def setup_collection(
        ...
        **kwargs,
        ...
        if not legacy_exists:
            ...
            return
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZVMGR4WWc9PTpjNzM0MjBhYw==
...
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZVMGR4WWc9PTpjNzM0MjBhYw==
    ...
    async def delete(self, ids: List[str]) -> None:
        ...
        try:
            if not ids:
                return
# noqa  My80OmFIVnBZMlhsa0xUb3Y2bzZVMGR4WWc9PTpjNzM0MjBhYw==
