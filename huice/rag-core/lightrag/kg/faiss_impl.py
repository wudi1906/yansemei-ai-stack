...
class FaissVectorDBStorage(BaseVectorStorage):
    ...
    def __post_init__(self):
        ...
        self._id_to_meta = {}
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZURTlKV2c9PTo5OGRkNjc1ZQ==
...
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZURTlKV2c9PTo5OGRkNjc1ZQ==
    ...
    def _find_faiss_id_by_custom_id(self, custom_id: str):
        ...
        for fid, meta in self._id_to_meta.items():
            if meta.get("__id__") == custom_id:
                return fid
        return None
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZURTlKV2c9PTo5OGRkNjc1ZQ==
...
# fmt: off  My80OmFIVnBZMlhsa0xUb3Y2bzZURTlKV2c9PTo5OGRkNjc1ZQ==
