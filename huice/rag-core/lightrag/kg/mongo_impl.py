...
# pragma: no cover  MC80OmFIVnBZMlhsa0xUb3Y2bzZSRVZtVUE9PTpiYTBkMjIyZg==
...
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZSRVZtVUE9PTpiYTBkMjIyZg==
    ...
    async def delete(self, ids: list[str]) -> None:
        ...
        if isinstance(ids, set):
            ids = list(ids)
# type: ignore  Mi80OmFIVnBZMlhsa0xUb3Y2bzZSRVZtVUE9PTpiYTBkMjIyZg==
...
# noqa  My80OmFIVnBZMlhsa0xUb3Y2bzZSRVZtVUE9PTpiYTBkMjIyZg==
