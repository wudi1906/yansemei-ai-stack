...
# pylint: disable  MC80OmFIVnBZMlhsa0xUb3Y2bzZTR2RUTlE9PTo1MDkyNjAzNg==
...
# type: ignore  MS80OmFIVnBZMlhsa0xUb3Y2bzZTR2RUTlE9PTo1MDkyNjAzNg==
    ...
    async def get_nodes_batch(self, node_ids: list[str]) -> dict[str, dict]:
        ...
        async with self._driver.session(
            ...
            return nodes
# fmt: off  Mi80OmFIVnBZMlhsa0xUb3Y2bzZTR2RUTlE9PTo1MDkyNjAzNg==
    ...
    async def edge_degrees_batch(
        ...
        return edge_degrees
# fmt: off  My80OmFIVnBZMlhsa0xUb3Y2bzZTR2RUTlE9PTo1MDkyNjAzNg==
