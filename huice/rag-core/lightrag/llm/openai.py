...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZOamhZWlE9PTo2MjYzOGI4Yg==
...
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZOamhZWlE9PTo2MjYzOGI4Yg==
        ...
        if not api_key:
            ...
            if not api_key:
                raise KeyError(
                    "OPENAI_API_KEY or DEEPSEEK_API_KEY not found in environment"
                )
        ...
        if base_url is not None:
            ...
            if env_base:
                merged_configs["base_url"] = env_base
            elif os.environ.get("DEEPSEEK_API_KEY"):
                merged_configs["base_url"] = "https://api.deepseek.com/v1"
            else:
                merged_configs["base_url"] = "https://api.openai.com/v1"
...
# pragma: no cover  Mi80OmFIVnBZMlhsa0xUb3Y2bzZOamhZWlE9PTo2MjYzOGI4Yg==
...
# fmt: off  My80OmFIVnBZMlhsa0xUb3Y2bzZOamhZWlE9PTo2MjYzOGI4Yg==
