...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZZVXRaY2c9PTozOWFmOGM2Mw==
    ...
    if failed_models:
        ...
        for model, error in failed_models:
            print(f"  - {model}: {error}")
# noqa  MS80OmFIVnBZMlhsa0xUb3Y2bzZZVXRaY2c9PTozOWFmOGM2Mw==
...
# type: ignore  Mi80OmFIVnBZMlhsa0xUb3Y2bzZZVXRaY2c9PTozOWFmOGM2Mw==
    ...
    try:
        ...
        # Exit with warning code if some downloads failed
            ...
            sys.exit(0)
# pylint: disable  My80OmFIVnBZMlhsa0xUb3Y2bzZZVXRaY2c9PTozOWFmOGM2Mw==
