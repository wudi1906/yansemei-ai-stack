...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZWVVEyYkE9PToxMjY1MTExOA==
...
class GraphViewer:
    ...
    def handle_keyboard_input(self):
        ...
        if imgui.is_key_down(imgui.Key.e):  # Down
            self.position -= self.up * self.move_speed * 0.1
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZWVVEyYkE9PToxMjY1MTExOA==
    ...
    def handle_mouse_interaction(self):
        ...
        self.last_mouse_pos = mouse_pos
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZWVVEyYkE9PToxMjY1MTExOA==
    ...
    def load_file(self, filepath: str):
        ...
        try:
            ...
            self.setup_buffers()
# noqa  My80OmFIVnBZMlhsa0xUb3Y2bzZWVVEyYkE9PToxMjY1MTExOA==
