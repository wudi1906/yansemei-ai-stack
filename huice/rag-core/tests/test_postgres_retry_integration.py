...
# type: ignore  MC80OmFIVnBZMlhsa0xUb3Y2bzZaVU5LWWc9PTplZGI5YzA4Mg==
...
# fmt: off  MS80OmFIVnBZMlhsa0xUb3Y2bzZaVU5LWWc9PTplZGI5YzA4Mg==
    ...
    async def test_pool_close_timeout_real(self, db_config, test_env):
        ...
        try:
            await db.initdb()
            print("  ✓ Database initialized")
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZaVU5LWWc9PTplZGI5YzA4Mg==
...
# pragma: no cover  My80OmFIVnBZMlhsa0xUb3Y2bzZaVU5LWWc9PTplZGI5YzA4Mg==
