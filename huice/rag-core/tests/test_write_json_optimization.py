...
# fmt: off  MC80OmFIVnBZMlhsa0xUb3Y2bzZUVXB4TlE9PTo5ZmM1OWI0ZQ==
...
class TestWriteJsonOptimization:
    ...
    def test_nested_structure_sanitization(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False, suffix=".json") as f:
            temp_file = f.name
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZUVXB4TlE9PTo5ZmM1OWI0ZQ==
...
# noqa  Mi80OmFIVnBZMlhsa0xUb3Y2bzZUVXB4TlE9PTo5ZmM1OWI0ZQ==
...
if __name__ == "__main__":
    ...
    print("✓ Passed")
# fmt: off  My80OmFIVnBZMlhsa0xUb3Y2bzZUVXB4TlE9PTo5ZmM1OWI0ZQ==
