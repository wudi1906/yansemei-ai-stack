...
# pylint: disable  MC80OmFIVnBZMlhsa0xUb3Y2bzZkVmhXVXc9PTpkOWE3ODhhYw==
...
async def initialize_graph_storage():
    ...
    try:
        ...
        return None
# pragma: no cover  MS80OmFIVnBZMlhsa0xUb3Y2bzZkVmhXVXc9PTpkOWE3ODhhYw==
...
# fmt: off  Mi80OmFIVnBZMlhsa0xUb3Y2bzZkVmhXVXc9PTpkOWE3ODhhYw==
...
async def test_graph_batch_operations(storage):
    ...
    try:
        ...
        print(f"Inserting edge 2: {node2_id} -> {node3_id}")
        await storage.upsert_edge(node2_id, node3_id, edge2_data)
# type: ignore  My80OmFIVnBZMlhsa0xUb3Y2bzZkVmhXVXc9PTpkOWE3ODhhYw==
