...
def validate_references_format(references: List[Dict[str, Any]]) -> bool:
    ...
    if not isinstance(references, list):
        ...
        return False
# pylint: disable  MC80OmFIVnBZMlhsa0xUb3Y2bzZhRm94YUE9PToyNTBkZTIwNA==
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if "response" not in data:
                ...
                return False
# fmt: off  MS80OmFIVnBZMlhsa0xUb3Y2bzZhRm94YUE9PToyNTBkZTIwNA==
...
# pylint: disable  Mi80OmFIVnBZMlhsa0xUb3Y2bzZhRm94YUE9PToyNTBkZTIwNA==
...
# pylint: disable  My80OmFIVnBZMlhsa0xUb3Y2bzZhRm94YUE9PToyNTBkZTIwNA==
