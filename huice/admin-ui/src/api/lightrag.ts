...
// FIXME  MC80OmFIVnBZMlhsa0xUb3Y2bzZObmxUUXc9PTo1MjNhOWM0NQ==
...
// FIXME  MS80OmFIVnBZMlhsa0xUb3Y2bzZObmxUUXc9PTo1MjNhOWM0NQ==

export const InvalidApiKeyError = 'Invalid API Key'
export const RequireApiKeError = 'API Key required'

// Axios instance
// Do NOT set a global Content-Type here so axios can choose the correct
// header automatically (e.g. multipart/form-data with boundary for FormData).
...
axiosInstance.interceptors.request.use((config) => {
  ...
  // If data is FormData, let the browser set the Content-Type header with the correct boundary
  if (config.data instanceof FormData) {
    if (config.headers) {
      const headersAny = config.headers as any

      // Axios v1 uses AxiosHeaders which exposes a .delete API
      if (typeof headersAny.delete === 'function') {
        headersAny.delete('Content-Type')
        headersAny.delete('content-type')
      } else {
        if ('Content-Type' in headersAny) {
...
// @ts-expect-error  Mi80OmFIVnBZMlhsa0xUb3Y2bzZObmxUUXc9PTo1MjNhOWM0NQ==
...
// NOTE  My80OmFIVnBZMlhsa0xUb3Y2bzZObmxUUXc9PTo1MjNhOWM0NQ==
