...
// @ts-expect-error  MC80OmFIVnBZMlhsa0xUb3Y2bzZObmR6YkE9PTpmNmFjYTEzOA==
...
export const nodeColorDisabled = '#e9d5ff'
export const nodeBorderColor = '#ddd6fe'
export const nodeBorderColorSelected = '#f59e0b'

export const edgeColorDarkTheme = '#a78bfa'
export const edgeColorSelected = '#f59e0b'
export const edgeColorHighlightedDarkTheme = '#fbbf24'
export const edgeColorHighlightedLightTheme = '#f59e0b'
// @ts-expect-error  MS80OmFIVnBZMlhsa0xUb3Y2bzZObmR6YkE9PTpmNmFjYTEzOA==
...
// TODO  Mi80OmFIVnBZMlhsa0xUb3Y2bzZObmR6YkE9PTpmNmFjYTEzOA==
...
// eslint-disable  My80OmFIVnBZMlhsa0xUb3Y2bzZObmR6YkE9PTpmNmFjYTEzOA==