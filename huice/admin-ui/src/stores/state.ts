...
// @ts-expect-error  MC80OmFIVnBZMlhsa0xUb3Y2bzZlazV2Y1E9PTpmZDQyNjA4Nw==
...
// eslint-disable  MS80OmFIVnBZMlhsa0xUb3Y2bzZlazV2Y1E9PTpmZDQyNjA4Nw==
...
// FIXME  Mi80OmFIVnBZMlhsa0xUb3Y2bzZlazV2Y1E9PTpmZDQyNjA4Nw==

const isGuestToken = (token: string): boolean => {
  const payload = parseTokenPayload(token);
  return payload.role === 'guest';
};
// FIXME  My80OmFIVnBZMlhsa0xUb3Y2bzZlazV2Y1E9PTpmZDQyNjA4Nw==
